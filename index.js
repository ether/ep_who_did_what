...
exports.eejsBlock_timesliderScripts = function(fn, args, cb){
  args.content = args.content + eejs.require("ep_who_did_what/static/js/whoDidWhat.js");
...
exports.eejsBlock_timesliderEditbarRight = function(fn, args, cb){
  args.content = args.content + eejs.require("ep_who_did_what/templates/button.ejs", {}, module);
  return cb();
}

exports.eejsBlock_timesliderBody = function(fn, args, cb){
  args.content = args.content + eejs.require("ep_who_did_what/templates/modal.ejs", {}, module);
}
